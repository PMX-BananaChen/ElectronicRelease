    ...
    public partial class UserApply : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //    if (loginempid.Trim().TrimStart('0') == empno.Trim().TrimStart('0'))
                //    {
                //        a = "您有多條新的申請待簽核\r\r" + "申請員工: " + empname + "\r操作時間: " + TimeA;
                //    }
                //    else
                //    {
                //        a = "您有多條新的申請待簽核\r\r" + "申請員工: " + loginname + "代" + empname + "\r操作時間: " + TimeA;
                //    }
                ...
                //    DA.ExecuteReader("insert into WX_Agent_Message (agent_name,to_user,content,link_url,title,create_time) select   top 1  'fangxing',work_user_id,'" + a + "','" + linkurl + "','待簽核通知(PC端申請)'," + t + " from WX_Employee_User   where  cast(employee_code as int )='" + manager.Trim().TrimStart('0') + "'  order  by  Create_Time desc ");
                ...
                //    if (loginempid.Trim().TrimStart('0') == empno.Trim().TrimStart('0'))
                //    {
                //        a = "您有一條新的申請待簽核\r\r" + "申請員工: " + empname + "\r操作時間: " + TimeA;
                //    }
                //    else
                //    {
                //        a = "您有一條新的申請待簽核\r\r" + "申請員工: " + loginname + "代" + empname + "\r操作時間: " + TimeA;
                //    }
                ...
                //    DA.ExecuteReader("insert into WX_Agent_Message (agent_name,to_user,content,link_url,title,create_time) select   top 1  'fangxing',work_user_id,N'" + a + "','" + linkurl + "',N'待簽核通知(PC端申請)'," + t + " from WX_Employee_User   where  cast(employee_code as int )='" + manager.Trim().TrimStart('0') + "'   order  by  Create_Time desc ");
